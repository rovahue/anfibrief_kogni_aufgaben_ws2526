...
\ifml
    \item[TODO Movie Night -- Tuesday, October 14th \YEAR, 19:00, Sand]~\\%, 19:00, Sand]~\\
...
% Kogni Info Abend
\ifkogwiss
	\item[Kognitionswissenschaft Info Abend -- Donnerstag, 16. Oktober \YEAR, Sand]~\\%, 18:30 Uhr, Sand
	Einige Fragen stehen vielleict noch offen zu diesem Zeitpunkt über das Studium. Vor allem in der Kognitionswissenschaft, mit Veranstaltungen in vielen verschiedenen Studiengängen kann die Organisation des Studiums etwas unübersichtlich sein. Für einen Ort wo man ohne Probleme Fragen stellen kann, wenn die FAQ Seite des Studiums nicht alles erklärt, bieten wir diesen durch die Fachschaft an. Hier werden wir einiges erzählen, dass wir gewollt hätten als Ersti gesagt bekommen zu haben.
	\seticon{faBus}~\textbf{Bushaltestelle:} Sand Drosselweg (Linien 2 \& 6)
\fi
...
\ifkogwiss
     \item[Schnuppersitzung der fsk -- Donnerstag, 20. November \YEAR, 18:30 (reguläre Sitzungen: Donnerstags, 18:30, vor dem Kogni Zimmer), Sand]~\\%Donnerstag, 18. Mai \YEAR, 18:30 Uhr, Sand]~\\
