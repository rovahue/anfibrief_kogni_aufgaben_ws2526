...
%TODO: jedes Jahr updaten
\usepackage{pdfpages}
\ifkogwiss
\fett{Ersti WhatsApp Chat}
\begin{itemize}
	\item \texttt{Ersti Chat} Dies ist ein link zu einer schon erstelten Ersti WhatsApp Gruppe für alle Kognis. Bitte nicht veröffentlichen. Da wir, die Fachschaft dies erstellt haben, können wir dadurch auch organisatorische Informationen an euch schicken, wie Einladungen zu Ersti Events. Dies ersetzt nicht eine anmeldung an die oben beschriebenen Listen, aber dies erlaubt Kontakt an andere Erstis.\\
	Beitreten unter \url{https://chat.whatsapp.com/BVJImo4CX7z2FT3EPVsjcy}.\\
	Oder via \includepdf[options]{media/kogni\_ersti\_chat\_whatsapp\_group\_invite\_link\_qrcode.pdf} 
\end{itemize}
\fi